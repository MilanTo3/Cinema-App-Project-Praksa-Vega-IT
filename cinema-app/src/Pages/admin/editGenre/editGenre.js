...
export default function EditGenreFrom({ id }){
    ...
    useEffect(() => {
        getGenre(id).then(function (response) {
    ...
    useEffect(() => {
        ...
        if(Object.keys(formErrors).length === 0 && isSubmit){
            ...
            console.log(data);
            updateGenre(data).then(function (response){
				setsnackbarType(0);
                setsnackbarContent("Genre edited successfully.");
