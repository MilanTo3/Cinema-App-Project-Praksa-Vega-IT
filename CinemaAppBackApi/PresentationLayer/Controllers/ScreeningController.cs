...
public class ScreeningController : ControllerBase
{
    ...
    [HttpGet]
    [Route("getPaginated/")]
    public async Task<IActionResult> getPaginated([FromQuery]int page, [FromQuery]int itemCount, [FromQuery(Name = "letters[]")] char[]? letters = null, [FromQuery] string? searchTerm = null){
